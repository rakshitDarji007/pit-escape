...
/** @type {string} */
const CACHE_VERSION = '1755143695|94671483868';
/** @type {string} */
const CACHE_PREFIX = 'pit-escape-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'pit-escape.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["pit-escape.html","pit-escape.js","pit-escape.offline.html","pit-escape.icon.png","pit-escape.apple-touch-icon.png","pit-escape.audio.worklet.js","pit-escape.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["pit-escape.wasm","pit-escape.pck"];
